...
int setup(void)
{
    ...
    add_collision_component_to_entity(player_entity_id, 32, 64, 32, 14, false, LAYER_PLAYER, (LAYER_PLAYER | LAYER_ENEMY | LAYER_HAZARD | LAYER_PICKUP | LAYER_WORLD));
    ...
    add_collision_component_to_entity(second_player_entity, 32, 64, 32, 14, false, LAYER_PLAYER, (LAYER_PLAYER | LAYER_ENEMY | LAYER_HAZARD | LAYER_PICKUP | LAYER_WORLD));
    ...
    add_collision_component_to_entity(tree_entity, 36, 90, 24, 48, true, LAYER_WORLD, LAYER_WORLD);
